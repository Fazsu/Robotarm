classdef KandiFinal < matlab.apps.AppBase

    % Properties that correspond to app components
    properties (Access = public)
        figure1                  matlab.ui.Figure
        ClawButtonGroup          matlab.ui.container.ButtonGroup
        ClosedButton             matlab.ui.control.RadioButton
    ...
    properties (Access = private)
       ...
       %ArduinoObject
       arduinoObj;
       %Change this port to correspond your ArduinoPort
       ArduinoPort = 'COM4';
    end
    ...
    methods (Access = private)
        ...
        function Reset_Callback(app, event)
            ...
            set( handles.text5,'String', num2str(17.5));
            set( handles.text6,'String', num2str(2));
            set(handles.slider1, 'value', 0);
            set(handles.slider2, 'value', 17.5);
        ...
        function SetPointButtonPushed(app, event)
          ...
          claw = app.Claw;
          formatSpec = '\n%s;%i;%i;%i;%i;*';
          fprintf(fileID,formatSpec,time,j1,j2,j3,claw);
          fclose(fileID);
        end
        ...
        function SendtoRobotButtonPushed(app, event)
            try 
                fid = fopen("robot_coordinates.txt");
                for k=1:2
                    tline = fgets(fid);
                end
                while ischar(tline)
                    disp(tline);
                    writeline(app.arduinoObj, tline);
                    tline = fgets(fid);
                end
                writeline(app.arduinoObj, 'k');
                app.textStatus.Text = 'Data Sent'; 
                
                pause(5);
                
                app.textStatus.Text = 'Done';
                pause(1);
        ...
        function ConnectButtonPushed(app, event)
            ...
            try 
                app.arduinoObj = serialport(app.ArduinoPort, 9600);
                app.textStatus.Text = 'Online';
        ...
        function ClearButtonPushed(app, event)
          ...
          fprintf(fileID,'%c','T;S1;S2;S3;Claw;LB');
          fclose(fileID);
          try 
              writeline(app.arduinoObj, 'c');
              reply = readline(app.arduinoObj);
              disp(reply);
          catch ME
        ...
        % Selection changed function: ClawButtonGroup
        function ClawButtonGroupSelectionChanged(app, event)
            selectedButton = app.ClawButtonGroup.SelectedObject;
            if(selectedButton == app.ClosedButton)
                app.Claw = app.ClawClosed;
            end
            if(selectedButton == app.OpenButton)
                app.Claw = app.ClawOpen;
            end
        end
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.figure1.Position = [520 214 702 657];
            app.figure1.Name = 'IK';
            ...
            app.axes1.Tag = 'axes1';
            app.axes1.Position = [45 228 614 416];
            ...
            app.textEucE.Position = [398 16 79 17];
            app.textEucE.Text = '0';
            ...
            app.text4.Position = [423 115 52 22];
            app.text4.Text = '0';
            ...
            app.text3.Position = [138 44 24 20];
            app.text3.Text = 'z';
            ...
            app.text2.Position = [141 78 24 20];
            app.text2.Text = 'y';
            ...
            app.text1.Position = [138 116 24 20];
            app.text1.Text = 'x';

            % Create slider1
            app.slider1 = uislider(app.figure1);
            app.slider1.Limits = [-30 30];
            ...
            app.slider1.Position = [162 125 263 3];

            % Create slider2
            app.slider2 = uislider(app.figure1);
            app.slider2.Limits = [2 30];
            ...
            app.slider2.Position = [165 87 262 3];
            app.slider2.Value = 17.5;
            ...
            app.slider3.Position = [162 53 263 3];
            app.slider3.Value = 2;
            ...
            app.text5.Position = [426 77 52 22];
            app.text5.Text = '17.5';
            ...
            app.text6.Position = [423 43 52 22];
            app.text6.Text = '2';
            ...
            app.inversebutton.Position = [489 89 192 41];
            app.inversebutton.Text = 'Calculate next point';
            ...
            app.Reset.Position = [488 22 191 40];
            ...
            app.text9.Position = [336 14 74 20];
            ...
            app.SetPointButton.Position = [399 174 84 22];
            ...
            app.TimesEditFieldLabel.Position = [227 174 49 22];
            ...
            app.ManualTimeValue.Position = [291 174 100 22];
            ...
            app.SendtoRobotButton.Enable = 'off';
            app.SendtoRobotButton.Position = [491 155 188 43];
            ...
            app.TimeSettingsButtonGroup.FontSize = 9;
            app.TimeSettingsButtonGroup.Position = [6 150 100 71];

            % Create ManualButton
            app.ManualButton = uiradiobutton(app.TimeSettingsButtonGroup);
            app.ManualButton.Text = 'Manual';
            app.ManualButton.FontSize = 9;
            app.ManualButton.Position = [11 29 52 22];
            ...
            app.AutomaticButton.FontSize = 9;
            app.AutomaticButton.Position = [11 7 62 22];
            ...
            app.text7.FontSize = 14;
            app.text7.Position = [6 110 100 32];
            ...
            app.textStatus.Position = [22 77 68 34];
            ...
            app.ConnectButton.Position = [11 55 90 22];
            ...
            app.ViewPointsButton.Position = [16 22 80 22];
            app.ViewPointsButton.Text = 'View Points';
            ...
            app.PointsPanel.Visible = 'off';
            app.PointsPanel.Position = [42 228 617 416];
            ...
            app.AutomaticTimeValue.Visible = 'off';
            app.AutomaticTimeValue.Position = [195 13 81 22];
            ...
            app.textTime.Visible = 'off';
            app.textTime.Position = [138 13 74 22];
            app.textTime.Text = 'Time:';

            % Create ClawButtonGroup
            app.ClawButtonGroup = uibuttongroup(app.figure1);
            app.ClawButtonGroup.SelectionChangedFcn = createCallbackFcn(app, @ClawButtonGroupSelectionChanged, true);
            app.ClawButtonGroup.Title = 'Claw';
            app.ClawButtonGroup.FontSize = 9;
            app.ClawButtonGroup.Position = [120 152 100 69];

            % Create OpenButton
            app.OpenButton = uiradiobutton(app.ClawButtonGroup);
            app.OpenButton.Text = 'Open';
            app.OpenButton.FontSize = 9;
            app.OpenButton.Position = [11 27 58 22];
            app.OpenButton.Value = true;

            % Create ClosedButton
            app.ClosedButton = uiradiobutton(app.ClawButtonGroup);
            app.ClosedButton.Text = 'Closed';
            app.ClosedButton.FontSize = 9;
            app.ClosedButton.Position = [11 5 65 22];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = KandiFinal(varargin)
